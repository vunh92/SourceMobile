...
import 'package:cooler_mdlz/model/enum/outlet_status_enum.dart';
import 'package:cooler_mdlz/model/outlet/outlet_model.dart';
...
class AllOutletScreen extends StatefulWidget {
  const AllOutletScreen({Key? key}) : super(key: key);

  @override
  State<AllOutletScreen> createState() => _AllOutletScreenState();
}

class _AllOutletScreenState extends State<AllOutletScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<HomeController>(
        ...
        builder: (controller) {
          return Obx(() {
            if(homeController.allOutlets.isEmpty && homeController.searchAllOutlets.isEmpty) {
              return _emptyWidget();
            }
            if(homeController.searchAllOutlets.isNotEmpty) {
              return _buildBody(homeController.searchAllOutlets);
            }
            return _buildBody(homeController.allOutlets);
          });
        }
    );
  }

...
class _Constant {
  ...
  static get title => 'Danh sách cửa hàng';
}
...
class _TodayScreenState extends State<TodayScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<HomeController>(
        ...
        builder: (controller) {
          return Obx(() {
            if(homeController.todayOutlets.isEmpty && homeController.searchOutletVisits.isEmpty) {
              return _emptyWidget();
            }
            if(homeController.searchOutletVisits.isNotEmpty) {
              return _buildBody(homeController.searchOutletVisits);
            }
            return _buildBody(homeController.todayOutlets);
          });
        }
    );
  }
